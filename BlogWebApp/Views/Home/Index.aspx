...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <% var makaleler = (IEnumerable<BlogWebApp.Models.makaleHelper>)ViewBag.makaleList;
     ...
     <div class="content_wrapper">                    
                    ...
                    <p><b>Kategori :</b> <a href="http://validator.w3.org/check?uri=referer" rel="nofollow"><%Response.Write(item.kategoriAdi); %></a> </p> 
        ...
        <%int sayfasayisi = Convert.ToInt32(ViewBag.sayfasayisi);
          ...
          if (sayfasayisi > 1)
          {
              for (int i = 1; i <= sayfasayisi; i++)
              {
                  ...
                  {
                      Response.Write("<li><a href='"+Url.Action("index",new{id=i} )+"'>" + i + "</b></a></li>");
                  }
              }
          } %>
            </ul>
